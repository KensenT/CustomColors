#
# Be sure to run `pod lib lint niceColor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'niceColor'
  s.version          = '0.1.0'
  s.summary          = 'A collection of custom color templates.'
...
TODO: A collection of custom color templates for your projects.
  ...
  s.source_files = 'niceColor/Classes/**/*'
  
  # s.resource_bundles = {
  #   'niceColor' => ['niceColor/Assets/*.png']
  # }
